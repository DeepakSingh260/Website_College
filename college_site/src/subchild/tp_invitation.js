  ...
  return (
    <div className='About_us'>
      ...
      <div className="Introduction" style={{marginLeft:"8%" }}>
        ...
        <p>  Dear Sir/Madam, </p>
    <p>&nbsp;&nbsp;  Government Collge of Engineering and Technology, Jammu is one of the prestigious Engineering College in India (established in 1994). The College is conducting five B.E. courses. The students are groomed to meet all the present and future requirements of the Industry.
</p>
